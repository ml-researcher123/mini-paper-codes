...
\definecolor{artifactblue}{HTML}{005A9C}
...
\noindent\textbf{Anonymous code and data:}\\[-1pt]
\href{https://anonymous.4open.science/r/quantization-and-agreement-in-homogeneous-llm-panels}{\textcolor{artifactblue}{%
\nolinkurl{https://anonymous.4open.science/r/}\allowbreak%
\nolinkurl{quantization-and-agreement-in-}\allowbreak%
\nolinkurl{homogeneous-llm-panels}}}
...
\caption{Paired \nf{} minus \fp{} effects with 95\% question-bootstrap intervals. Negative accuracy and positive $\beta$/AURC values indicate degradation. The $\Delta\kappa$ panel shows no consistent change in conditional same-wrong concentration; gray crosses mark the sparse GSM8K estimates, where exact same-wrong events occur at most once per condition.}
\label{fig:deltas}
\end{figure*}
...
OpenAI Codex was used for research ideation and framing, literature discovery, code development, analysis checks, and language editing. The author independently verified the experimental outputs, citations, code, and manuscript and remains responsible for the work.
...
The experiment uses five samples per question and base seed 20260809, with member seed $20260809+5i+k$. The final runtime uses Transformers 4.57.6, bitsandbytes 0.50.0, and \fp{} compute for \nf{}. Phi remote model code is pinned to revision \texttt{2fe1924}. Raw JSONL generations, configuration files, environment records, analysis code, and 10,000-replicate bootstrap outputs are provided through the anonymous repository linked after the Introduction.
